...
public class Enemy6 : TASEnemy
{
	private sealed class _ComboBullet_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			if (this._i___1 < 5)
			{
				this._this.Pool.GetEBullet(this._this.Pool.EBullN2, this._this.Pool.NEBullN2, this._this.Pool.GEBullN2, this._this.BullPos.position, this._tar___0, true, this._this.DamageBullet);
	...
	{
		Enemy6._ComboBullet_c__Iterator0 _ComboBullet_c__Iterator = new Enemy6._ComboBullet_c__Iterator0();
