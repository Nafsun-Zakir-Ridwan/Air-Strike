...
public class Enemy5 : TASEnemy
{
	private sealed class _ComboBullet_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			if (this._i___1 < 5)
			{
				this._this.Pool.GetEBullet(this._this.Pool.EBullN1, this._this.Pool.NEBullN1, this._this.Pool.GEBullN1, this._this.BullPos.position, this._tar___0, true, this._this.DamageBullet);
	...
	{
		Enemy5._ComboBullet_c__Iterator0 _ComboBullet_c__Iterator = new Enemy5._ComboBullet_c__Iterator0();
