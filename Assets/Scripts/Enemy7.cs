...
public class Enemy7 : TASEnemy
{
	private sealed class _ComboBullet_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			if (this._i___1 < 5)
			{
				this._this.Pool.GetEBullet(this._this.Pool.EBullN3, this._this.Pool.NEBullN3, this._this.Pool.GEBullN3, this._this.BullPos.position, this._tar___0, true, this._this.DamageBullet);
	...
	{
		Enemy7._ComboBullet_c__Iterator0 _ComboBullet_c__Iterator = new Enemy7._ComboBullet_c__Iterator0();
