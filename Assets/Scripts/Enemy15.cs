...
public class Enemy15 : TASEnemy
{
	private sealed class _ComboBullet_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			if (this._i___1 < 4)
			{
				...
				this._this.Pool.GetEBullet(this._this.Pool.EBullCombo2, this._this.Pool.NEBullCombo2, this._this.Pool.GEBullCombo2, this._this.BullPos.position, this._tar___2, true, this._this.DamageBullet);
	...
	{
		Enemy15._ComboBullet_c__Iterator0 _ComboBullet_c__Iterator = new Enemy15._ComboBullet_c__Iterator0();
