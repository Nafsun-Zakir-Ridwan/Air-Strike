...
namespace DigitalRuby.LightningBolt
{
	...
	{
		[global::Tooltip("The game object where the lightning will emit from. If null, StartPosition is used.")]
		public GameObject StartObject;

		[global::Tooltip("The start position where the lightning will emit from. This is in world space if StartObject is null, otherwise this is offset from StartObject position.")]
		public Vector3 StartPosition;

		[global::Tooltip("The game object where the lightning will end at. If null, EndPosition is used.")]
		public GameObject EndObject;

		[global::Tooltip("The end position where the lightning will end at. This is in world space if EndObject is null, otherwise this is offset from EndObject position.")]
		public Vector3 EndPosition;

		[global::Tooltip("How manu generations? Higher numbers create more line segments."), Range(0f, 8f)]
		public int Generations = 6;

		[global::Tooltip("How long each bolt should last before creating a new bolt. In ManualMode, the bolt will simply disappear after this amount of seconds."), Range(0.01f, 1f)]
		public float Duration = 0.05f;

		private float timer;

		[global::Tooltip("How chaotic should the lightning be? (0-1)"), Range(0f, 1f)]
		public float ChaosFactor = 0.15f;

		[global::Tooltip("In manual mode, the trigger method must be called to create a bolt")]
		public bool ManualMode;

		[global::Tooltip("The number of rows in the texture. Used for animation."), Range(1f, 64f)]
		public int Rows = 1;

		[global::Tooltip("The number of columns in the texture. Used for animation."), Range(1f, 64f)]
		public int Columns = 1;

		[global::Tooltip("The animation mode for the lightning")]
		...
		{
			if (TASPlayerControl.Instance.CurHealth > 0f)
			{
				TASPlayerControl.Instance.LaserHited(0.5f);
			}
		...
		{
			this.EndObject = TASPlayerControl.Instance.gameObject;
		...
		public void Trigger()
		{
			...
			else if (this.EndObject.activeInHierarchy)
			{
